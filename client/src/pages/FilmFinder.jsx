    ...
    <div>
      <div className="filmFinderBody">
        ...
        <div className="contentBlock">
          ...
          <p>
            A university project written by myself and four other students. It was written on a MERN framework (MongoDB,
            Express, React, Node). Whilst we all contributed to multiple backend and database code, I was mainly working
            on the frontend. The site utilizes Material UI, has a togglable dark mode, and is mobile friendly.
          </p>
          <p>
            Due to plaigirism rules, I cannot show the code publicly, but send me a message, and I&apos;ll be happy to
            chat about it.
          </p>
        </div>
        <div className="contentBlock">
        ...
        <ProjectsBlock currentProject="Film Finder" />
        <BackToTopButton />
      </div>

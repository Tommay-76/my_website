  ...
  return (
    <div>
      ...
      <div style={{ padding: "20px", textAlign: "center" }}>
        <h3>Add a name:</h3>
        <TextField label="Name" type="text" value={newName} onChange={(event) => setNewName(event.target.value)} />

        <Button onClick={() => addName(newName)} color="primary" variant="contained">
          Add name
        </Button>
        <div>

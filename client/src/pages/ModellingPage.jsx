    ...
    <div>
      <div className="filmFinderBody">
        ...
        <div className="contentBlock">
          ...
          <p>
            Done for a intro to vfx subject. I created models, textures, lights and shaders to create realistic rendered
            scenes.
          </p>
          <p>
            The bedroom is built upon the ideas of the novel 1984 by George Orwell, of which you may notice a passage
            quoted on the wall. The prison island was actually a collaboration with another student using assets from
            both our individual projects.
          </p>
        </div>
        <div className="contentBlock">
          <h3>Library</h3>
